                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <Link to={'/login'} class="ms-1 text-white hover:text-gray-300 duration-300">
                                            Login
                                        </Link>
                                    </div>
                                </li>
            ...
            <section className='container mx-auto flex justify-center flex-col items-center'>
                ...
                <div className='rounded-xl shadow-2xl lg:w-[75%] w-[100%] px-9 py-5 mb-5'>
                    <form class="mx-auto mt-4">
                        <div>
                            <p className='text-3xl font-semibold text-center pb-5'>LOGIN YOUR ACCOUNT</p>
                        ...
                        <button type="submit" class="text-white mt-5 bg-[#f96822] hover:bg-[#f0824a] rounded-lg text-lg w-full px-5 py-6 text-center shadow-xl">Login</button>
                    </form>
                </div>
            </section>
        </>
